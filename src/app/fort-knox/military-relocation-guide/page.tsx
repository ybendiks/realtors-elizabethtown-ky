  ...
  return (
    ...
    >
      ...
      <div className="bg-navy rounded-lg p-6 text-white mt-10">
        <h2 className="text-xl font-bold text-white mb-2">Relocating to Fort Knox? Let a Veteran Help.</h2>
        <p className="text-gray-300 text-sm mb-4">
          ...
          <Link href="/fort-knox/off-post-housing/" className="text-gold hover:text-gold-light">
            off-post housing
          </Link>{" "}
