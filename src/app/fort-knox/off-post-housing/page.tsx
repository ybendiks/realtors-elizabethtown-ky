  ...
  return (
    ...
    >
        ...
        <table className="w-full border-collapse text-sm">
          <thead>
            <tr className="bg-navy text-white">
              <th className="text-left p-3 font-semibold">Community</th>
              <th className="text-center p-3 font-semibold">Drive to Knox</th>
              <th className="text-center p-3 font-semibold">Median Home</th>
              <th className="text-center p-3 font-semibold">Avg Rent (3BR)</th>
      ...
      <div className="bg-navy rounded-lg p-6 text-white mt-10">
        <h2 className="text-xl font-bold text-white mb-2">Find Your Off-Post Home Near Fort Knox</h2>
