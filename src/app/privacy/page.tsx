    ...
    <ContentLayout breadcrumbs={[{ label: "Privacy Policy" }]}>
      ...
      <div className="prose max-w-none text-gray-body space-y-6">
        ...
        <p>
          ...
          wish to update or remove your information, please contact us at question@agentmail.to.
        </p>
        ...
        <p>
          If you have questions about this privacy policy, contact us at question@agentmail.to.
        </p>
      </div>
    </ContentLayout>
  );
